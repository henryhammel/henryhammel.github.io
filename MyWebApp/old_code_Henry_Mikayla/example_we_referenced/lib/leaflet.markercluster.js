...
!function(t, e) {
    L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        eachLayer: function(t, e) {
            ...
            for (this._topClusterLevel && this._topClusterLevel.getAllChildMarkers(n),
            i = n.length - 1; i >= 0; i--)
                t.call(e, n[i]);
        ...
        zoomToShowLayer: function(t, e) {
            ...
            if (t._icon && this._map.getBounds().contains(t.getLatLng()))
                e();
                ...
                var n = function() {
                    this._map.off("movestart", n, this),
                    n = null
                };
        ...
        _removeLayer: function(t, e, i) {
            ...
            for (this._arraySplice(u, t); _ && (_._childCount--,
            !(_._zoom < 0)); )
                e && _._childCount <= 1 ? (h = _._markers[0] === t ? _._markers[1] : _._markers[0],
                ...
                _._icon && (r.removeLayer(_),
                i || r.addLayer(h))) : (_._recalculateBounds(),
                i && _._icon || _._updateIcon()),
                _ = _.__parent;
            delete t.__parent
        },
        ...
        _addLayer: function(t, e) {
            ...
            for (this.options.singleMarkerMode && (t.options.icon = this.options.iconCreateFunction({
                ...
                if (o = r[e].getNearObject(i)) {
                    ...
                    for (a._addChild(_),
                    n = e; n >= 0 && r[n].removeObject(o, this._map.project(o.getLatLng(), n)); n--)
                        ;
                    return
                }
                r[e].addObject(t, i)
        ...
        _mergeSplitClusters: function() {
            this._processQueue(),
            this._zoom < this._map._zoom && this._currentShownBounds.intersects(this._getExpandedVisibleBounds()) ? (this._animationStart(),
    ...
    L.MarkerClusterGroup.include(L.DomUtil.TRANSITION ? {
        ...
        _animationZoomIn: function(t, e) {
            ...
            this._topClusterLevel._recursively(n, t, 0, function(r) {
                ...
                r._isSingleParent() && t + 1 === e ? (s.removeLayer(r),
                r._recursivelyAddChildrenToMap(null, e, n)) : (r.setOpacity(0),
    ...
    L.MarkerCluster.include({
        ...
        spiderfy: function() {
            if (this._group._spiderfied !== this && !this._group._inZoomAnimation) {
                ...
                e.length >= this._circleSpiralSwitchover ? t = this._generatePointsSpiral(e.length, s) : (s.y += 10,
    ...
    L.MarkerCluster.include(L.DomUtil.TRANSITION ? {
        ...
        _animationSpiderfy: function(t, i) {
            ...
            for (n = t.length - 1; n >= 0; n--)
                s = t[n],
                s.setOpacity ? (s.setZIndexOffset(1e6),
                s.setOpacity(0),
                u.addLayer(s),
                s._setPos(l)) : u.addLayer(s);
            h._forceLayout(),
            h._animationStart();
            var d = L.Path.SVG ? 0 : .3
              , p = L.Path.SVG_NS;
            for (n = t.length - 1; n >= 0; n--)
                if (o = _.layerPointToLatLng(i[n]),
                s = t[n],
            ...
            L.Path.SVG)
                ...
                n = t.length - 1; n >= 0; n--)
                    s = t[n]._spiderLeg,
                    s.options.opacity = .5,
                    s._path.setAttribute("stroke-opacity", .5);
            setTimeout(function() {
                h._animationEnd(),
                h.fire("spiderfied")
            }, 200)
        ...
        _animationUnspiderfy: function(t) {
            ...
            setTimeout(function() {
                ...
                for (i = h.length - 1; i >= 0; i--)
                    e = h[i],
                    e._spiderLeg && (e.setOpacity && (e.setOpacity(1),
                    e.setZIndexOffset(0)),
                    t > 1 && o.removeLayer(e),
